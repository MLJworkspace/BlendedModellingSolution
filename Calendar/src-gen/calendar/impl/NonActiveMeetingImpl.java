...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Non Active Meeting</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link calendar.impl.NonActiveMeetingImpl#getParticipant <em>Participant</em>}</li>
 *   <li>{@link calendar.impl.NonActiveMeetingImpl#getAgenda <em>Agenda</em>}</li>
 *   <li>{@link calendar.impl.NonActiveMeetingImpl#getNonactivemeeting <em>Nonactivemeeting</em>}</li>
 *   <li>{@link calendar.impl.NonActiveMeetingImpl#getActivemeeting <em>Activemeeting</em>}</li>
 *   <li>{@link calendar.impl.NonActiveMeetingImpl#getDivision <em>Division</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NonActiveMeetingImpl extends PersonImpl implements NonActiveMeeting {
	/**
	 ...
	 * @generated
	 */
	protected NonActiveMeetingImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CalendarPackage.Literals.NON_ACTIVE_MEETING;
	}
	...
	public EList<Participant> getParticipant() {
		if (participant == null) {
			participant = new EObjectContainmentWithInverseEList<Participant>(Participant.class, this,
					CalendarPackage.NON_ACTIVE_MEETING__PARTICIPANT, CalendarPackage.PARTICIPANT__MEETING);
		}
		return participant;
	}
	...
	public NotificationChain basicSetAgenda(Agenda newAgenda, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CalendarPackage.NON_ACTIVE_MEETING__AGENDA, oldAgenda, newAgenda);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAgenda != agenda) {
			...
			if (agenda != null)
				msgs = ((InternalEObject) agenda).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CalendarPackage.NON_ACTIVE_MEETING__AGENDA, null, msgs);
			if (newAgenda != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CalendarPackage.NON_ACTIVE_MEETING__AGENDA, newAgenda,
					newAgenda));
	}
			...
			if (nonactivemeeting != oldNonactivemeeting) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CalendarPackage.NON_ACTIVE_MEETING__NONACTIVEMEETING, oldNonactivemeeting,
							nonactivemeeting));
			}
		}
	...
	public void setNonactivemeeting(NonActiveMeeting newNonactivemeeting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CalendarPackage.NON_ACTIVE_MEETING__NONACTIVEMEETING,
	...
	public ActiveMeeting getActivemeeting() {
		if (activemeeting != null && activemeeting.eIsProxy()) {
			...
			if (activemeeting != oldActivemeeting) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CalendarPackage.NON_ACTIVE_MEETING__ACTIVEMEETING, oldActivemeeting, activemeeting));
			}
		}
	...
	public void setActivemeeting(ActiveMeeting newActivemeeting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CalendarPackage.NON_ACTIVE_MEETING__ACTIVEMEETING,
	...
	public Division getDivision() {
		if (eContainerFeatureID() != CalendarPackage.NON_ACTIVE_MEETING__DIVISION)
			return null;
	...
	public NotificationChain basicSetDivision(Division newDivision, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newDivision, CalendarPackage.NON_ACTIVE_MEETING__DIVISION, msgs);
		return msgs;
	}
	...
	public void setDivision(Division newDivision) {
		if (newDivision != eInternalContainer()
				|| (eContainerFeatureID() != CalendarPackage.NON_ACTIVE_MEETING__DIVISION && newDivision != null)) {
			...
			if (newDivision != null)
				msgs = ((InternalEObject) newDivision).eInverseAdd(this, CalendarPackage.DIVISION__NONACTIVEMEETING,
						Division.class, msgs);
			msgs = basicSetDivision(newDivision, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CalendarPackage.NON_ACTIVE_MEETING__DIVISION,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CalendarPackage.NON_ACTIVE_MEETING__PARTICIPANT:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getParticipant()).basicAdd(otherEnd, msgs);
		case CalendarPackage.NON_ACTIVE_MEETING__DIVISION:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case CalendarPackage.NON_ACTIVE_MEETING__AGENDA:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case CalendarPackage.NON_ACTIVE_MEETING__DIVISION:
			return eInternalContainer().eInverseRemove(this, CalendarPackage.DIVISION__NONACTIVEMEETING, Division.class,
					msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case CalendarPackage.NON_ACTIVE_MEETING__AGENDA:
			return getAgenda();
		case CalendarPackage.NON_ACTIVE_MEETING__NONACTIVEMEETING:
			if (resolve)
				return getNonactivemeeting();
			return basicGetNonactivemeeting();
		case CalendarPackage.NON_ACTIVE_MEETING__ACTIVEMEETING:
			if (resolve)
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Meeting.class) {
			...
			case CalendarPackage.MEETING__PARTICIPANT:
				return CalendarPackage.NON_ACTIVE_MEETING__PARTICIPANT;
			case CalendarPackage.MEETING__AGENDA:
				return CalendarPackage.NON_ACTIVE_MEETING__AGENDA;
			case CalendarPackage.MEETING__NONACTIVEMEETING:
				return CalendarPackage.NON_ACTIVE_MEETING__NONACTIVEMEETING;
			case CalendarPackage.MEETING__ACTIVEMEETING:
				return CalendarPackage.NON_ACTIVE_MEETING__ACTIVEMEETING;
			default:
				return -1;
			}
		}
