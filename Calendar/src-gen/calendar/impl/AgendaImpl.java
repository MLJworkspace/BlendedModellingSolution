 ...
 * </p>
 * <ul>
 *   <li>{@link calendar.impl.AgendaImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgendaImpl extends MinimalEObjectImpl.Container implements Agenda {
	...
	protected EClass eStaticClass() {
		return CalendarPackage.Literals.AGENDA;
	}
	...
	public EList<Item> getItem() {
		if (item == null) {
			item = new EObjectContainmentEList<Item>(Item.class, this, CalendarPackage.AGENDA__ITEM);
		}
		return item;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CalendarPackage.AGENDA__ITEM:
