...
public class MappingParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MappingGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMappingRuleAccess().getGroup_3(), "rule__MappingRule__Group_3__0");
			builder.put(grammarAccess.getMappingRuleAccess().getGroup_3_2(), "rule__MappingRule__Group_3_2__0");
			...
			builder.put(grammarAccess.getMappingRuleAccess().getGroup_8_2(), "rule__MappingRule__Group_8_2__0");
			builder.put(grammarAccess.getMappingRuleAccess().getGroup_9(), "rule__MappingRule__Group_9__0");
			builder.put(grammarAccess.getMappingRuleAccess().getGroup_9_2(), "rule__MappingRule__Group_9_2__0");
			...
			builder.put(grammarAccess.getMappingRuleAccess().getSourceAssignment_3_1(), "rule__MappingRule__SourceAssignment_3_1");
			builder.put(grammarAccess.getMappingRuleAccess().getEEnumLiteralAssignment_3_2_1(), "rule__MappingRule__EEnumLiteralAssignment_3_2_1");
			builder.put(grammarAccess.getMappingRuleAccess().getTargetAssignment_4_1(), "rule__MappingRule__TargetAssignment_4_1");
			builder.put(grammarAccess.getMappingRuleAccess().getOperatorAssignment_5_1(), "rule__MappingRule__OperatorAssignment_5_1");
			builder.put(grammarAccess.getMappingRuleAccess().getConditionAssignment_6_1(), "rule__MappingRule__ConditionAssignment_6_1");
			builder.put(grammarAccess.getMappingRuleAccess().getCommentAssignment_7_1(), "rule__MappingRule__CommentAssignment_7_1");
			builder.put(grammarAccess.getMappingRuleAccess().getChildRulesAssignment_8_1(), "rule__MappingRule__ChildRulesAssignment_8_1");
			builder.put(grammarAccess.getMappingRuleAccess().getChildRulesAssignment_8_2_1(), "rule__MappingRule__ChildRulesAssignment_8_2_1");
			builder.put(grammarAccess.getMappingRuleAccess().getChildHelpersAssignment_9_1(), "rule__MappingRule__ChildHelpersAssignment_9_1");
			builder.put(grammarAccess.getMappingRuleAccess().getChildHelpersAssignment_9_2_1(), "rule__MappingRule__ChildHelpersAssignment_9_2_1");
